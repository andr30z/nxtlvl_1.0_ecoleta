...
import Dropzone from "../../components/dropzpone/dropzone";
...
const CreatePoint = () => {
    ...
    const handleSubmit = async (event: FormEvent) => {
        ...
        console.log(data)
        await api.post('points', data).then(function (response) {
            alert('Ponto Criado!!');
            history.push('/');
        })
            .catch(function (error) {
                alert('Algo de deu errado! :(')
            });;
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <ul className="items-grid">
                        {items.map(item => (
                            <li className={selectedItems.includes(item.id) ? 'selected' : ''} onClick={() => handleSelectItem(item.id)} key={item.id}>
